...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BullsEye",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8BullsEye30AboutViewControlViewController")
@interface AboutViewControlViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)close;
...
SWIFT_CLASS("_TtC8BullsEye11AppDelegate")
