...
def main():
    ...
    backgroundMusic = pygame.mixer.music.load('resources/sound/game_music.wav')
    pygame.mixer.music.play(-1, 0.0)

    enemy_shoot_sound = pygame.mixer.Sound('resources/sound/enemy3_down.wav')
    ...
    gameOver_music = pygame.mixer.music.load('resources/sound/game_over.wav')
